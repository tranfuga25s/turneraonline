...
class EstadisticasController extends AppController {
	...
	public function administracion_usuariosDeclarados() {
		...
		$datos = $this->Usuario->find( 'all', array( 'group' => 'grupo_id', 'fields' => array( 'id_usuario', 'grupo_id' ) ) );
	...
	public function administracion_usuariosActivos( $meses = 1 ) {
		...
		$total_pacientes = $this->Usuario->find( 'count', array( 'conditions' => array( 'grupo_id' => 1 ) ) );
