...
class GruposController extends AppController {
	...
	public function administracion_add() {
		if ($this->request->is('post')) {
			...
			if ($this->Grupo->save($this->request->data)) {
				$this->Session->setFlash( 'El grupo ha sido guardado correctamente', 'flash/success' );
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash( 'El grupo no pudo ser guardado correctamente', 'flash/error' );
			}
		}
	}
	...
	public function administracion_edit($id = null) {
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			if ($this->Grupo->save($this->request->data)) {
				$this->Session->setFlash( 'El grupo fue modificado correctamente', 'flash/success' );
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash( 'El grupo no pudo ser guardado', 'flash/error' );
			}
		} else {
	...
	public function administracion_delete($id = null) {
		...
		$this->Session->setFlash( 'Verificación de eliminación de grupo sin usuarios no implementada. No se eliminó el grupo.', 'flash/info' );
		$this->redirect( array( 'action' => 'index' ) );
		return;
		if ($this->Grupo->delete()) {
			$this->Session->setFlash( 'Grupo eliminado correctamente' );
			$this->redirect( array( 'action' => 'index' ) );
		}
