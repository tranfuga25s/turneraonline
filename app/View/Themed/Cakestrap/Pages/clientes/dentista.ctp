...
<div class="row-fluid">
	<div class="span12">
		<h3>Sistema de turnos para dentistas</h3>
		<p>	Todo el sistema se encuentra preparado para que una sola persona sea capaz de administrarlo.<br />
			Sin necesidad de secretarias ni intermediarios. El dentista administra y mantiene todos los turnos.</p>
	</div>
</div>
<div class="row-fluid">
	<div class="span6">
			...
			<table class="table table-condensed table-hover">
				<tbody>
					<tr>
						...
						<td align="left">Todo es administrable por el dentista del sistema.</td>
					</tr>
					<tr>
						<td width="20"><span class="icon-check">&nbsp;</span></td>
						<td>Ventana de turnos auto-actualizable para el dentista.</td>
					</tr>
					<tr>
						<td width="20"><span class="icon-check">&nbsp;</span></td>
