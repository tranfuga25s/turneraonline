...
<div id="pestanas" class="decorado1">
	...
	<div class="usuarios" id="pest-1">
		<table cellpadding="0" cellspacing="0"><tbody><tr><td>
		<div class="titulo1">Datos</div>
		<dl>
			<dt>Email</dt>
			<dd>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td class="actions">
					...
					<?php echo $this->Form->postLink( 'Cancelar', array( 'controller' => 'secretarias', 'action' => 'cancelar', $turno['Turno']['id_turno']), null, 'Esta seguro que desea cancelar el turno?' ); ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</table>
