...
<br />
<div class="decorado1">
	<div class="titulo1">Lista de Usuarios</div>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link( $usuario['ObraSocial']['nombre'], array('controller' => 'obra_social', 'action' => 'view', $usuario['ObraSocial']['id_obra_social'])); ?>
		</td>
		<!--<td>
