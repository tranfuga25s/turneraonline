...
<div class="index">
	...
	<fieldset>
		...
		<dl>
			...
			<?php echo $this->requestAction( array( 'action' => 'renderizar_aviso', $aviso['Aviso']['id_aviso'], 'email' ) ); ?>
	...
	<fieldset>
		...
		<dl>
			...
			<dd><?php echo ($aviso['Aviso']['para']['celular'] == '' ) ? "Sin dato" : h( $aviso['Aviso']['para']['celular'] ); ?></dd>
