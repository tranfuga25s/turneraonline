<?php
$this->set( 'title_for_layout', "Sistema de turnos para Hospitales y Sanatorios" );
?>
<style>
.flotatipo {
	float: left;
...
<div class="decorado1">
	...
	<div class="flotatipo"><?php echo $this->Html->image( 'cabecera.png' ); ?>Hospitales y Sanatorios</div>
	<br />
	<br />
