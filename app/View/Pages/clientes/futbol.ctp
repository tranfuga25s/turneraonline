...
<div class="decorado1">
	<div class="titulo1">Sistema de turnos para canchas de futbol y ligas amateur</div>
	<div class="flotatipo"><?php echo $this->Html->image( 'cabecera.png' ); ?>Canchas de futbol</div>
	<br />
	<br />
