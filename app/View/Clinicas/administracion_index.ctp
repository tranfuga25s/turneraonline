  ...
  <tbody>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink( 'Eliminar', array('action' => 'delete', $clinica['Clinica']['id_clinica']), null, __('Are you sure you want to delete # %s?', $clinica['Clinica']['id_clinica'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
  </tbody>
