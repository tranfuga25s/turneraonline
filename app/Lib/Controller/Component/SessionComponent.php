...
class SessionComponent extends Component {
	...
	public function correcto( $mensaje ) {
		$this->setFlash( $mensaje, 'default', array( 'class' => 'success' ) );
	}
	
	public function incorrecto( $mensaje ) {
		$this->setFlash( $mensaje, 'default', array( 'class' => 'error' ) );
	}
	
	public function peligro( $mensaje ) {
		$this->setFlash( $mensaje, 'default', array( 'class' => 'warning' ) );
	}
}
